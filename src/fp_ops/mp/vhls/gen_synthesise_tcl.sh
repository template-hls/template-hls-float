...
CPPFLAGS="-D__SYNTHESIS__=1 -DTHLS_SYNTHESIS=1 -DTHLS_FW_UINT_ON_AP_UINT=1 -std=c++11 -O3 -I ${REPOPATH}/include  -IE:/dt10_all/external/hls/template_hls_2/include ${EXTRACOMPILERFLAGS}"
